...
#CL-CD graph
plt.plot(F.C_L(cET, cVt, crho), F.C_D(cThrust,cVt,crho))
...
#CD-alpha graph
plt.plot(ca, F.C_D(cThrust,cVt,crho))
...
#CL**2-CD graph
plt.plot(F.C_D(cThrust,cVt,crho), F.C_L(cET, cVt, crho)**2)
plt.plot(F.C_D(cThrust,cVt,crho), p(F.C_D(cThrust,cVt,crho)))
