...
# For Cl-Cd
cET=f[:,2][27:33] #Elapsed time
chp=f[:,3][27:33]*0.3048 #Pressure height [m]
cIAS=(f[:,4][27:33]-2)*1852/3600 #Indicated airspeed (already calibtated and converted to [m/s])
ca=f[:,5][27:33] #Angle of attack [deg]
cFFL=f[:,6][27:33]*0.453592/3600 #Fuel flow left [kg/s]
cFFR=f[:,7][27:33]*0.453592/3600 #Fuel flow right [kg/s]
cFused=f[:,8][27:33]*0.453592 #Fuel used
cTAT=f[:,9][27:33]+273.15 #Total measured air temperature
...
cThrust=thrust[:,0][0:6]+thrust[:,1][0:6]
eThrust=thrust[:,0][6:13]+thrust[:,1][6:13]
eSthrust=thrust[:,0][13:20]+thrust[:,1][13:20]
